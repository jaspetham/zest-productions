<template>
  <section id="about" class="section-split">
    <div
      id="aboutMessage"
      class="my-10 mx-auto text-center font-black uppercase opacity-0 content-p"
      style="max-width: 120ch; transform: translateY(-100%)"
    >
      <span class="fs-400 ff-title"
        >Whether it's media production, or media management... be it for
        <span class="text-main">personal</span> use or for your
        <span class="text-main">business</span> - we are here for exactly for that very
        reason.</span
      >
    </div>
    ...
    <div id="aboutSection" class="relative content-p mt-15">
      <div class="relative z-10">
        <h1 class="fs-500 about-text">
          We're a <span class="text-main">media</span> studio with a committed
          <span class="text-main">team</span> working on projects for startups and
          companies, we make your idea into a reality through:
          <span class="inner-text"
            >branding & visual design of the highest
            <span class="text-main">quality</span>.</span
          >
        </h1>
