<template>
  <section class="section-split">
      <div class="scroll-thing-wrapper">
        ...
        <section class="lg:hidden scroll-thing">
          ...
          <div class="marquee-container">
            <div class="marquee" style="--play:running; --direction:reverse; --duration:60; --delay:0s; --iteration-count:infinite;">
              <h2 class="scroll-text">Jengs Homemade Brownies / BoBo Restaurant & Cafe / V Beauty Cosmetics / Cinnamonkins</h2>
            </div>
          </div>
        </section>
    ...
    mounted(){
      ...
      const headerHeight = document.querySelector('nav').offsetHeight;
        window.addEventListener('scroll', () => {{
          ...
          if (window.scrollY > (elementTarget.offsetTop - 120)) {
