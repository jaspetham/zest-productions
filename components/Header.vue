  ...
  <nav id="nav">
    <div class="nav-container flex justify-between items-center">
      ...
      <div
        ...
        class="menu-items">
        <div class="menu-body">
          <div class="header-link"><a @click="menuState" href="#"> Home <font-awesome-icon class="header-icon" :icon="['far', 'compass']"/></a></div>
          <div class="header-link"><a @click="menuState" href="#about"> About <font-awesome-icon class="header-icon" :icon="['far', 'compass']"/></a></div>
          <div class="header-link"><a @click="menuState" href="#services"> Services <font-awesome-icon class="header-icon" :icon="['far', 'compass']"/></a></div>
          <div class="header-link"><a @click="menuState" href="#showcase"> Showcase <font-awesome-icon class="header-icon" :icon="['far', 'compass']"/></a></div>
          <div class="header-link"><a @click="menuState" href="#"> Contact <font-awesome-icon class="header-icon" :icon="['far', 'compass']"/></a></div>
        </div>
