...
.service {
  box-shadow: 0 10px 20px rgba(var(--clr-main), 0.6);
...
.service-style .circle {
  ...
  width: 12px;
  height: 12px;
  box-shadow: 0 1px 12px rgba(var(--clr-main), 0.6);
}
.service-style .line {
  width: 100px;
  height: 5px;
  ...
  left: -5px;
  z-index: -1;
  box-shadow: 0 1px 8px rgba(var(--clr-main), 0.6);
}
.service-icon {
  background: rgba(var(--clr-main));
  border-radius: 50%;
